 ...
 const events_list=[
  {
    ...
    img: "/restaurant/events_img3.jpg",
  },
  {
  ...
  },
  {
    ...
    img: "/restaurant/events_img2.jpg",
  },
  {
    ...
    img: "/restaurant/events_img4.jpg",
  },
];
        ...
        <Container sx={{overflow:'hidden'}}>
            <Stack className="events_main">
               ...
               <Box className='prev_next_frame'>
                  ...
                  <img 
                    src="icons/Arrow-right.svg" className="swiper-button-next" 
                    alt=""
                   />
               </Box>
               <Swiper
                            ...
                            <Box className={'events_desc'}>
                              <Box className={'events_bott'}>
                                <Box className={'bott_left'}>
                                  <div className={'event_tite_speaker'}>
                                  ...
                                  <p 
                                    ...
                                    >
                                      <div className={"bott_info_main"}>
                                        <img src="/icons/calendar.svg" style={{marginRight:'10px'}} alt="" 
                                        />
                                        {value.date}
                                      </div>
                                      <div className={"bott_info_main"}>
                                        <img src="/icons/location.svg" style={{marginRight:'10px'}} alt="" 
                                        />
                                        {value.location}
                                      </div>
                                    </div>
