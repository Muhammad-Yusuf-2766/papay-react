        ...
        <Stack className="order_right">
          ...
          <Box className='payment_box'>
            <form action="#">
                ...
                <input style={{width: "162px", marginRight:'10px    '}} type="date" placeholder="7/24: " />
                <input style={{width: "162px"}} type="number" placeholder="CVV: 010: " />
                </Box>
                 <input type="text" placeholder="Full name:" />
                <Box className='cards'>
                    <a href="#"><img src="/icons/Western-union.svg" alt="" /></a>
                    <a href="#"><img src="/icons/mastercard.svg" alt="" /></a>
                    <a href="#"><img src="/icons/Paypal.svg" alt="" /></a>
                    <a href="#"><img src="/icons/visa.svg" alt="" /></a>
                </Box>
            </form>
          </Box>
        </Stack>
