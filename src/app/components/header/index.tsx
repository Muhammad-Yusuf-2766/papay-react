    ...
    <div className='format home_navbar'>
       <Container>
        ...
        <Stack className='head_information' justifyContent={'row'} >
          <Stack justifyContent={'column'} sx={{marginTop: "86px", marginLeft: "26px"}} >
            <Box>
...
Restaurant & Cafe</Box>
            ...
            <Box sx={{mt:'90px'}}>
                <Button variant='contained' style={{width:'210px', height:'60px', background:'#1976D2',color:'white'}} >RO’YHATDAN O’TISH</Button>
            </Box>
          </Stack>
